...
void main() {
  ...
  test(
    ...
    'l\'asset — et désigne UNIQUEMENT la convention du CONTOUR DXF BRUT '
    '(profil_mm a son max(y)==0 côté plafond pour D705, au lieu de '
    'min(y)==0 pour D718/D720), jamais la convention du CANVAS Flutter '
    '(Y croît vers le bas), qui est une question SANS RAPPORT, couverte '
    'séparément par persp_geometry_test.dart (perpDown/perpUp, '
    'convention canvas Y-down — deux conventions disjointes, jamais '
    'couvertes par le même test, voir la docstring de ce dernier '
    'fichier pour le détail de cette distinction). Ce que ce cas '
    'apporte ICI : un TROISIÈME jeu de valeurs '
